describe('crocad', ->
    describe('sphere', ->
        it('generates the same values as the Python script', ->
    ...
    describe('row', ->
        ...
        it('can generate the first row', ->
            gen = row(null, 12)
            exp = new Crocad.InstructionGroup([new Crocad.Instruction(12,'ch')])
            expect(gen).toEqual(exp)
        )
        it('can generate an equal row', ->
            gen = row(12, 12)
            exp = new Crocad.InstructionGroup([new Crocad.Instruction(12)])
            expect(gen).toEqual(exp)
        )
        it('can generate an increasing row', ->
            gen = row(12, 13)
            exp = new Crocad.InstructionGroup([
                new Crocad.MultipleStitches(),
        ...
        it('can generate a decreasing row', ->
            gen = row(13, 12)
            exp = new Crocad.InstructionGroup([
                new Crocad.StitchTogether(),
                new Crocad.Instruction(11)
        ...
        it('can generate an increasing row with a repeat', ->
            gen = row(6, 9)
            exp = new Crocad.InstructionGroup([
                new Crocad.InstructionGroup([
                    new Crocad.MultipleStitches(),
        ...
        it('can generate a decreasing row with a repeat', ->
            gen = row(9, 6)
            exp = new Crocad.InstructionGroup([
                new Crocad.InstructionGroup([
                    new Crocad.StitchTogether(),
        ...
        it('can generate an increasing row with a repeat and a remainder', ->
            gen = row(8, 11)
            exp = new Crocad.InstructionGroup([
                new Crocad.InstructionGroup([
                    new Crocad.MultipleStitches(),
        ...
        it('can generate a decreasing row with a repeat and a remainder', ->
            gen = row(10, 7)
            exp = new Crocad.InstructionGroup([
                new Crocad.InstructionGroup([
                    new Crocad.StitchTogether(),
    ...
    describe('gcd', ->
        it('can calculate greatest common divisors', ->
            gcd = Crocad.gcd
    ...
    describe('roundToNearest', ->
        ...
        it('should ensure a minimum value', ->
    ...
    describe('Instruction', ->
        ...
        it('should have the same value for stitches as for stitchesInto', ->
            expect(new Crocad.Instruction(2).stitchesInto()).toBe(2)
        )
        it('should merge with other Instructions', ->
            i = new Crocad.Instruction(3)
            j = new Crocad.Instruction(4)
    ...
    describe('StitchTogether', ->
        it('can be instantiated', ->
            st = new Crocad.StitchTogether()
        ...
        it('should merge with other Instructions', ->
            i = new Crocad.StitchTogether(3)
            j = new Crocad.StitchTogether(4)
            expect(i.merge(j)).toBe(true)
            expect(i.stitches()).toBe(7)
    ...
    describe('MultipleStitches', ->
        it('can be instantiated', ->
            st = new Crocad.MultipleStitches()
            expect(st).not.toBeUndefined()
        ...
        it('should merge with other Instructions', ->
            i = new Crocad.MultipleStitches(3)
            j = new Crocad.MultipleStitches(4)
            expect(i.merge(j)).toBe(true)
    ...
    describe('InstructionGroup', ->
        it('can be instantiated', ->
            g = new Crocad.InstructionGroup()
            expect(g).not.toBeUndefined()
            expect(g.stitches()).toBe(0)
            expect(g.stitchesInto()).toBe(0)
        )
        it('can hold Instructions', ->
            Instruction = Crocad.Instruction
            g = new Crocad.InstructionGroup([
                new Instruction(),
                new Instruction(),
                new Instruction(),
        ...
        it('can correctly merge instructions', ->
            Instruction = Crocad.Instruction
